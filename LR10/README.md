# НС на PyTorch.
### 10-я лабораторная.
1. Пополнить `MNIST` 11-м классом "не цифры", поместив в него случайно выбранные буквы `EMNIST`. Дополнительный класс формируется из представителей всех классов `EMNIST`.
